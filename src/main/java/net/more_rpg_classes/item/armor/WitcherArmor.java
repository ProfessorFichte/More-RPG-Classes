...
public class WitcherArmor extends ModArmorItem implements GeoItem {
    ...
    public void setAttributes(Multimap<EntityAttribute, EntityAttributeModifier> attributes) {
        ...
        builder.put(MRPGCEntityAttributes.SIGN_INTENSITY,new EntityAttributeModifier(uuid,"sign_inc",1.0, EntityAttributeModifier.Operation.ADDITION));
        builder.put(MRPGCEntityAttributes.ADRENALINE_MODIFIER,new EntityAttributeModifier(uuid,"adrenaline_inc",0.01, EntityAttributeModifier.Operation.MULTIPLY_BASE));
