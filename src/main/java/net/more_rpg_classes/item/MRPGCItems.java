...
public class MRPGCItems {
    //public static final UUID INCOMING_DAMAGE_MODIFIER_ID = UUID.fromString("f8e5213e-fa22-413a-99ea-f7be068795b2");
    //public static final UUID ARMOR_MODIFIER_ID = UUID.fromString("c0e6f0a8-ba89-4a77-bfd5-7c930a3d81ef");
    public static final UUID SPELL_HASTE_MODIFIER_ID = UUID.fromString("d48115ce-e4b9-422c-a418-e6ebfd2ff550");
    public static final UUID SPELL_POWER_FROST_MODIFIER_ID = UUID.fromString("441b2252-db4b-45cd-856a-81ecd1e717bf");
    public static final UUID SPELL_POWER_LIGHTNING_MODIFIER_ID = UUID.fromString("695091c9-cef4-4bb9-b4cf-044ed111e674");
    public static final UUID SPELL_POWER_FIRE_MODIFIER_ID = UUID.fromString("6a0b3f36-e231-42f8-9b6e-b6489171f808");
    public static final UUID SPELL_POWER_ARCANE_MODIFIER_ID = UUID.fromString("66f5e13a-bb5e-49d7-94e8-9a56c5394b55");
    public static final UUID SPELL_POWER_SOUL_MODIFIER_ID = UUID.fromString("666d65ad-05e4-4efb-b6b8-96303604afba");
    //public static final UUID SPELL_POWER_HEALING_MODIFIER_ID = UUID.fromString("e0016e47-8423-473c-879d-044262748882");
    public static final UUID SPELL_CRIT_DAMAGE_MODIFIER_ID = UUID.fromString("0510491d-1ea4-4055-8666-383b95b23dd1");
    public static final UUID SPELL_CRIT_CHANCE_MODIFIER_ID = UUID.fromString("042b3a30-d2ad-406c-9483-b6444daa61d5");
    ...
    public static final Item WOODEN_KNUCKLE =registerItem("wooden_knuckle", new KnuckleItem(ToolMaterials.WOOD,
            knuckle_attackDamage,knuckle_attackSpeed,0.0f, 0.5f, new FabricItemSettings()));
    public static final Item STONE_KNUCKLE =registerItem("stone_knuckle", new KnuckleItem(ToolMaterials.STONE,
            knuckle_attackDamage, knuckle_attackSpeed, 0.01f,1, new FabricItemSettings()));
    public static final Item GOLD_KNUCKLE =registerItem("golden_knuckle", new KnuckleItem(ToolMaterials.GOLD,
            knuckle_attackDamage, knuckle_attackSpeed, 0.02f,2, new FabricItemSettings()));
    ...
    public static final Item DIAMOND_KNUCKLE =registerItem("diamond_knuckle", new KnuckleItem(ToolMaterials.DIAMOND,
            knuckle_attackDamage, knuckle_attackSpeed, 0.02f,3, new FabricItemSettings()));
    public static final Item NETHERITE_KNUCKLE =registerItem("netherite_knuckle", new KnuckleItem(ToolMaterials.NETHERITE,
            knuckle_attackDamage, knuckle_attackSpeed, 0.03f,3, new FabricItemSettings()));
    */
