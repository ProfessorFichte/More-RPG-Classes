...
public class BloodyKnuckleItem extends SpellWeaponItem {
    private final float attackDamage;
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public BloodyKnuckleItem(ToolMaterial material, float attackDamage, float attackSpeed, float afuse,
                             float haste, float arcanep, float scritchance, float lifesteal,Item.Settings settings) {
