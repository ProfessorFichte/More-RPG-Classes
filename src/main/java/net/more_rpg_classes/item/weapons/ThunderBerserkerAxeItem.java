...
public class ThunderBerserkerAxeItem extends SpellSwordItem {
    ...
    public ThunderBerserkerAxeItem(ToolMaterial material, float attackDamage, float attackSpeed,
                                   float rage, float scritdamage,float lightning, Item.Settings settings) {
        ...
        builder.put(EntityAttributes_SpellPower.POWER.get(MagicSchool.LIGHTNING), new EntityAttributeModifier(LIGHTNING_SPELLPOWER_MODIFIER_ID,
                "Weapon modifier", (double) lightning, EntityAttributeModifier.Operation.ADDITION));
