...
public class GuardianKnuckleItem extends SpellWeaponItem {
    private final float attackDamage;
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public GuardianKnuckleItem(ToolMaterial material, float attackDamage, float attackSpeed, float afuse,
