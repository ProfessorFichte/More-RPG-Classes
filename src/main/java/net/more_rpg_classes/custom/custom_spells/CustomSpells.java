    ...
    public static <string> void register() {
        ...
        CustomSpellHandler.register(new Identifier(MOD_ID, "burstcrack"), (data) -> {
            ...
            if (!data1.caster().getWorld().isClient) {
                ...
                for (Entity entity : list) {
                    SpellHelper.performImpacts(entity.getWorld(), data1.caster(), entity, SpellRegistry.getSpell(new Identifier(MOD_ID, "burstcrack")), data1.impactContext());
            ...
            for (Entity entity : data1.targets()) {
                ...
                if (entity instanceof LivingEntity living) {
                    ...
                    if (living.isUndead()) {
                        ...
                        SpellHelper.performImpacts(entity.getWorld(), data1.caster(), entity, SpellRegistry.getSpell(new Identifier(MOD_ID, "bloody_strike")), data1.impactContext());
        ...
        CustomSpellHandler.register(new Identifier(MOD_ID, "rumbling_swing"), (data) -> {
            ...
            if (currenthealth >= spellcost_rumbling_swing + 0.5f) {
                ...
                b *= range / d;
                c *= range / d;
                data1.caster().addVelocity((double) a, (double) b + 0.1, (double) c);
                if (!data1.caster().getWorld().isClient) {
                    for (Entity entity : data1.targets()) {
                        SpellHelper.performImpacts(entity.getWorld(), data1.caster(), entity, SpellRegistry.getSpell(new Identifier(MOD_ID, "rumbling_swing")), data1.impactContext());
                    }
                }
            } else {
        ...
        CustomSpellHandler.register(new Identifier(MOD_ID, "nordic_storm"), (data) -> {
            ...
            if (currenthealth >= spellcost_nordic_storm + 0.75f) {
                if (!data1.caster().getWorld().isClient) {
                    ...
                    for (Entity entity : list) {
                        SpellHelper.performImpacts(entity.getWorld(), data1.caster(), entity, SpellRegistry.getSpell(new Identifier(MOD_ID, "nordic_storm")), data1.impactContext());
        ...
        CustomSpellHandler.register(new Identifier(MOD_ID, "quen"), (data) -> {
            ...
            SpellHelper.performImpacts(data1.caster().getWorld(), data1.caster(), data1.caster(), SpellRegistry.getSpell(new Identifier(MOD_ID, "quen")), data1.impactContext());
            return true;
        });
    }
}
