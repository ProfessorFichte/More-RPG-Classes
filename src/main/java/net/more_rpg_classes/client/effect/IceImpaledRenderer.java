...
public class IceImpaledRenderer implements CustomModelStatusEffect.Renderer {

    private static final RenderLayer RENDER_LAYER = CustomLayers.spellEffect(LightEmission.RADIATE, true);
    public static final Identifier modelId = new Identifier(MRPGCMod.MOD_ID, "effect/icicle_renderer");

    @Override
    public void renderEffect(int amplifier, LivingEntity livingEntity, float delta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int light) {
        matrixStack.push();
        matrixStack.scale(1.25F,1.5F,1.25F);
