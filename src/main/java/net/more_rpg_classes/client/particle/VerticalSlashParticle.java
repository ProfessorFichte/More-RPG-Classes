...
public class VerticalSlashParticle extends SpriteBillboardParticle {
    public final SpriteProvider spriteProvider;

    public VerticalSlashParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        for (int k = 0; k < 4; ++k) {
            ...
            Vec3f2.rotate(new Quaternionf().rotateXYZ((float) Math.toRadians(110f+modifierX), 0f, -320f+modifierZ));
            Vec3f2.mul(j);
            Vec3f2.add(f, g, h);
        }
