...
public class CircleGroundParticle extends SpriteBillboardParticle {
    public final SpriteProvider spriteProvider;

    public CircleGroundParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
        super(world, x, y, z, velocityX, velocityY, velocityZ);
        this.velocityX = 0;
        this.velocityY = 0;
        this.velocityZ = 0;
        this.spriteProvider = spriteProvider;
        int modifier = 1 + new Random().nextInt(30);
        this.scale *= 5.0f + random.nextFloat() / 10f * modifier;
        this.maxAge = 8 + new Random().nextInt(modifier);
    }
