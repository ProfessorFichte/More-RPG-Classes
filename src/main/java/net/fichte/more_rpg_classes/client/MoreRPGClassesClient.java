package net.fichte.more_rpg_classes.client;

import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.fabric.api.client.particle.v1.ParticleFactoryRegistry;
import net.fichte.more_rpg_classes.MRPGCMod;
import net.fichte.more_rpg_classes.client.effect.FrozenSolidRenderer;
import net.fichte.more_rpg_classes.client.effect.MoltenArmorParticles;
import net.fichte.more_rpg_classes.client.effect.RageParticles;
