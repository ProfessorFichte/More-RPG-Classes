...
import static net.fichte.more_rpg_classes.item.MRPGCItems.SPELL_CRIT_DAMAGE_MODIFIER_ID;
import static net.fichte.more_rpg_classes.item.MRPGCItems.SPELL_POWER_FROST_MODIFIER_ID;
