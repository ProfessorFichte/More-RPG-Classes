...
import static net.fichte.more_rpg_classes.item.MRPGCItems.SPELL_POWER_FIRE_MODIFIER_ID;
import static net.fichte.more_rpg_classes.item.MRPGCItems.SPELL_POWER_LIGHTNING_MODIFIER_ID;
