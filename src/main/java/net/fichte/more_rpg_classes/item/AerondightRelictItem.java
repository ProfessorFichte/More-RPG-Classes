...
import static net.fichte.more_rpg_classes.item.MRPGCItems.SPELL_CRIT_CHANCE_MODIFIER_ID;
import static net.fichte.more_rpg_classes.util.CustomMethods.increaseAmpAndDuration;
