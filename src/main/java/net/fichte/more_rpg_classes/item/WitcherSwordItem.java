...
import static net.fichte.more_rpg_classes.item.MRPGCItems.*;
...
public class WitcherSwordItem extends SpellSwordItem {
    ...
    public WitcherSwordItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, float fire, float lightning, Item.Settings settings) {
