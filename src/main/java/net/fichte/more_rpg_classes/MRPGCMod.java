package net.fichte.more_rpg_classes;

import net.fabricmc.api.ModInitializer;
import net.fabricmc.fabric.api.particle.v1.FabricParticleTypes;
import net.fichte.more_rpg_classes.effect.MRPGCEffects;
import net.fichte.more_rpg_classes.entity.attribute.MRPGCEntityAttributes;
import net.fichte.more_rpg_classes.item.MRPGCBooks;
import net.fichte.more_rpg_classes.item.MRPGCGroup;
import net.fichte.more_rpg_classes.item.MRPGCItems;
import net.fichte.more_rpg_classes.util.MRPGCLootTableChestModifiers;
import net.fichte.more_rpg_classes.util.MRPGCLootTableEntityModifiers;
